...
type Operations = { social_accounts:Record<string,number>; privacy:Record<string,number>; exports:Record<string,number>; deletions:Record<string,number>; recent_exports:Array<{id:string;user:{email:string};status:string}>; scheduled_deletions:Array<{id:string;user:{email:string};scheduled_for:string}> };
