...
type Actor = { email:string; role:'moderator'|'super_admin' };
...
function App() {
    ...
    useEffect(() => { Promise.all([reloadQueues(),loadUsers(),loadAudits()]).catch(error => error.message === 'AUTH' && setAuthorized(false)); }, []);
    ...
    return <div className="shell"><aside><div className="brand">SOUL</div><span>Operations</span>
        <nav><a href="#overview">Overview</a><a href="#users">Users</a><a href="#reports">Reports</a><a href="#verification">Verification</a><a href="#audit">Audit log</a></nav>
