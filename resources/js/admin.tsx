...
type Operations = { social_accounts:Record<string,number>; privacy:Record<string,number>; exports:Record<string,number>; deletions:Record<string,number>; store_processing:Record<string,number>; notification_delivery:Record<string,number>; recent_delivery_failures:Array<{channel:string;provider:string;status:string;attempts:number;failure_code:string}>; recent_exports:Array<{id:string;user:{email:string};status:string}>; scheduled_deletions:Array<{id:string;user:{email:string};scheduled_for:string}> };
