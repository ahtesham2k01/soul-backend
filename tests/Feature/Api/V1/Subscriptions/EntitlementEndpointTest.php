...
class EntitlementEndpointTest extends TestCase
{
    ...
    public function test_super_admin_can_configure_complete_launch_catalog_without_prices(): void
    {
        ...
        $this->postJson('/api/v1/admin/entitlements/products', ['plan_id' => $planId, 'platform' => 'ios', 'product_id' => 'com.soul.launch.plus', 'country_code' => 'pk', 'is_active' => true, 'reason' => 'Map approved store product'])->assertCreated();
        $this->postJson('/api/v1/admin/entitlements/promotions', ['key' => 'launch_trial', 'name' => 'Launch trial', 'plan_id' => $planId, 'status' => 'active', 'country_code' => 'pk', 'platform' => 'ios', 'trial_days' => 14, 'rollout_percentage' => 25, 'starts_at' => now()->addDay()->toIso8601String(), 'ends_at' => now()->addMonth()->toIso8601String(), 'reason' => 'Schedule measured launch'])->assertCreated();
        ...
        $this->assertDatabaseCount('admin_audit_logs', 6);
    }
}
