...
class UserDevice extends Model {
 protected $fillable=['personal_access_token_id','platform','push_token','token_hash','device_name','last_seen_at','revoked_at'];
 protected $hidden=['id','user_id','personal_access_token_id','push_token','token_hash'];
