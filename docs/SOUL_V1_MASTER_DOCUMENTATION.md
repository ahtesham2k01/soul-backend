...
- [ ] Mobile M2 — Registration, social Apple/Google authentication, account-state routing and complete profile/religion onboarding (email registration, account routing and required profile/religion journey implemented; native Apple/Google credential acquisition and photos remain)
- [ ] Mobile M3 — Cloudinary photo onboarding, discovery preferences, candidate cards, Like/Pass and incoming Likes (photo selection/upload/register/replace/delete, privacy choice, moderation state and readiness refresh implemented; discovery surfaces remain)
