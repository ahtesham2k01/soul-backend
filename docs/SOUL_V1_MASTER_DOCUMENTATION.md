...
Marathi, Tamil and Telugu now provide reviewed draft copy for the first 138 of 179 member-facing keys. Their implemented journey covers bootstrap and location messages, social and email entry, authentication failures, shared actions, primary navigation, discovery, matching, chat presence/messaging, core profile creation, public/private photo review states, onboarding review/submission, report/block safety actions, notifications, privacy/account settings, active-device management, data download and deletion recovery, protected private-photo access and current legal-consent commitments. The remaining keys continue to use safe English fallbacks until later translation packages and native-language review.
