...
Brazilian Portuguese, European Portuguese, Polish and Ukrainian now have reviewed draft coverage for authentication, shared actions, primary navigation, chat presence/messaging, profile creation, photo review, onboarding review, discovery, matching, profile safety, private-photo protection, notification choices, privacy/account controls and legal-consent prompts. Their regional wording remains separate—for example Brazilian Portuguese uses “carregando/salvar/buscar”, while European Portuguese uses “a carregar/guardar/pesquisar”. Portuguese and Polish each have 137 of 179 member keys localized, while Ukrainian has 138; the remaining flows continue to use safe English fallbacks until their next translation package and native-language review.
